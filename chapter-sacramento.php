...
<div id="fh5co-page">
		<div id="fh5co-wrap">
			<header id="fh5co-hero" data-section="home" role="banner" style="background: url(images/chapter-sacramento.jpg) top left; background-size: cover;" >
					...
					<div class="container">
						<div class="row">
							...
							<div class="col-md-12 fh5co-text text-center">
								<h2 class="to-animate intro-animate-1">SACRAMENTO Chapter</h2>
								<p class="to-animate intro-animate-2">1174 Roseville Parkway<br />Roseville, CA 95678</p>
					...
					<div class="container">
						<div class="row">
							<div class="col-md-8 col-md-offset-2 fh5co-section-heading text-center">
								...
								<p class="fh5co-sub">1174 Roseville Parkway<br />Roseville, CA 95678</p>
							</div>
	...
	function initialize() {
	  var mapOptions = {
	    zoom: 14,
	    center: new google.maps.LatLng(38.768119, -121.270368),
