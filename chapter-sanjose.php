...
<div id="fh5co-page">
		<div id="fh5co-wrap">
			<header id="fh5co-hero" data-section="home" role="banner" style="background: url(images/chapter-sanjose.jpg) top left; background-size: cover;" >
					...
					<div class="container">
						<div class="row">
							...
							<div class="col-md-12 fh5co-text text-center">
								<h2 class="to-animate intro-animate-1">SAN JOSE Chapter</h2>
								<p class="to-animate intro-animate-2">940 Great Mall Dr.<br />Milpitas, CA 95035</p>
					...
					<div class="container">
						<div class="row">
							<div class="col-md-8 col-md-offset-2 fh5co-section-heading text-center">
								...
								<p class="fh5co-sub">940 Great Mall Dr.<br />Milpitas, CA 95035</p>
							</div>
	...
	function initialize() {
	  var mapOptions = {
	    zoom: 14,
	    center: new google.maps.LatLng(37.417004, -121.896958),
