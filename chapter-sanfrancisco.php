...
<div id="fh5co-page">
		<div id="fh5co-wrap">
			<header id="fh5co-hero" data-section="home" role="banner" style="background: url(images/chapter-sanfrancisco.jpg) top left; background-size: cover;" >
					...
					<div class="container">
						<div class="row">
							...
							<div class="col-md-12 fh5co-text text-center">
								<h2 class="to-animate intro-animate-1">SAN FRANCISCO Chapter</h2>
								<p class="to-animate intro-animate-2">200 Serramonte Center, Suite 200<br />Daly City, CA 94015</p>
					...
					<div class="container">
						<div class="row">
							<div class="col-md-8 col-md-offset-2 fh5co-section-heading text-center">
								...
								<p class="fh5co-sub">200 Serramonte Center, Suite 200<br />Daly City, CA 94015</p>
							</div>
	...
	function initialize() {
	  var mapOptions = {
	    zoom: 14,
	    center: new google.maps.LatLng(37.670726, -122.467991),
